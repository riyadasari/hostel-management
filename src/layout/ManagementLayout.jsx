...
import { LayoutDashboard, ListTodo, Megaphone, LogOut, Menu } from 'lucide-react';
...
const ManagementLayout = () => {
    ...
    const navItems = [
        { path: '/management/overview', label: 'Overview', icon: LayoutDashboard },
        { path: '/management/issues', label: 'Issue Manager', icon: ListTodo },
        { path: '/management/announcements', label: 'Announcements', icon: Megaphone },
    ];
        ...
        <div className="flex h-screen bg-gray-50 font-sans overflow-hidden">
            ...
            <div className="hidden md:flex w-64 flex-col bg-slate-900 text-white transition-all duration-300">
                ...
                <div className="h-16 flex items-center px-6 border-b border-slate-800 bg-slate-950">
                    ...
                    <span className="text-lg font-bold tracking-tight">HostelAdmin</span>
                </div>
                ...
                <div className="p-4 border-t border-slate-800 bg-slate-950">
                    <div className="flex items-center gap-3 mb-4 px-2">
                        ...
                        <div className="overflow-hidden">
                            <h4 className="text-sm font-semibold text-white truncate">{profile?.name || 'Admin'}</h4>
                            <Link to="/management/profile" className="text-xs text-orange-400 hover:text-orange-300 truncate block">View Profile</Link>
                        </div>
                    </div>
                    <button
            ...
            <div className="flex-1 flex flex-col overflow-hidden relative">
                ...
                <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:hidden z-20">
                    <div className="flex items-center">
                        <div className="w-8 h-8 bg-gradient-to-tr from-orange-500 to-red-600 rounded-lg flex items-center justify-center font-bold text-white text-lg mr-2">M</div>
                        <span className="text-lg font-bold text-gray-900">HostelAdmin</span>
                    </div>
